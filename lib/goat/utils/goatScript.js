...
exports.GoatScriptData = exports.ETH_PK_LENGTH = exports.PK_LENGTH = void 0;
const bitcoinjs_lib_1 = require("bitcoinjs-lib");
exports.PK_LENGTH = 32;
exports.ETH_PK_LENGTH = 20;
class GoatScriptData {
    constructor(posPubkey, delegatorKey, validatorKey, transferTimeLock, validatorIndex, nonce, evmAddress) {
        if (!Buffer.isBuffer(delegatorKey) || !Buffer.isBuffer(validatorKey) || !Buffer.isBuffer(evmAddress) || !Buffer.isBuffer(posPubkey) ||
    ...
    validate() {
        ...
        if (this.validatorKey.length !== exports.PK_LENGTH) {
            return false;
        }
...
exports.GoatScriptData = GoatScriptData;
