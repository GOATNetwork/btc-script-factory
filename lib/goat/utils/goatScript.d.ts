...
export declare class GoatScriptData {
    private posPubkey;
    ...
    private evmAddress;
    constructor(posPubkey: Buffer, delegatorKey: Buffer, validatorKey: Buffer, transferTimeLock: number, validatorIndex: number, nonce: number, evmAddress: Buffer);
    private validate;
    /**
