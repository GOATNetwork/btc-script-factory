...
class StakingScriptData {
    ...
    magicBytes) {
        ...
        _StakingScriptData_finalityProviderKeys.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _StakingScriptData_finalityProviderKeys, finalityProviderKeys, "f");
    ...
    validate() {
        ...
        if (__classPrivateFieldGet(this, _StakingScriptData_finalityProviderKeys, "f").some((finalityProviderKey) => finalityProviderKey.length != exports.PK_LENGTH)) {
            return false;
        }
    ...
    buildSlashingScript() {
        return Buffer.concat([
            __classPrivateFieldGet(this, _StakingScriptData_instances, "m", _StakingScriptData_buildSingleKeyScript).call(this, __classPrivateFieldGet(this, _StakingScriptData_stakerKey, "f"), true),
            __classPrivateFieldGet(this, _StakingScriptData_instances, "m", _StakingScriptData_buildMultiKeyScript).call(this, __classPrivateFieldGet(this, _StakingScriptData_finalityProviderKeys, "f"), 
    ...
    buildDataEmbedScript() {
        ...
        const serializedStakingData = Buffer.concat([
            ...
            version,
            __classPrivateFieldGet(this, _StakingScriptData_stakerKey, "f"),
            __classPrivateFieldGet(this, _StakingScriptData_finalityProviderKeys, "f")[0],
            stakingTimeLock,
        ]);
...
_StakingScriptData_stakerKey = new WeakMap(), _StakingScriptData_finalityProviderKeys = new WeakMap(), _StakingScriptData_covenantKeys = new WeakMap(), _StakingScriptData_covenantThreshold = new WeakMap(), _StakingScriptData_stakingTimeLock = new WeakMap(), _StakingScriptData_unbondingTimeLock = new WeakMap(), _StakingScriptData_magicBytes = new WeakMap(), _StakingScriptData_instances = new WeakSet(), _StakingScriptData_buildSingleKeyScript = function _StakingScriptData_buildSingleKeyScript(pk, withVerify) {
