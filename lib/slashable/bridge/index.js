...
exports.sendP2PKHTransaction = exports.depositP2PKHTransaction = exports.sendP2SHTransaction = exports.depositP2SHTransaction = exports.recaptureTransferTimelockTransaction = exports.sendTransaction = exports.depositTransaction = exports.BridgeScriptData = void 0;
const bitcoinjs_lib_1 = require("bitcoinjs-lib");
const internalPubkey_1 = require("../../constants/internalPubkey");
const script_1 = require("./script");
Object.defineProperty(exports, "BridgeScriptData", { enumerable: true, get: function () { return script_1.BridgeScriptData; } });
...
function depositP2PKHTransaction(scripts, amount, changeAddress, inputUTXOs, network, feeRate, keyPair) {
    ...
    if ((inputsSum - (amount + fee)) > constants_1.BTC_DUST_SAT) {
        psbt.addOutput({
            address: changeAddress,
