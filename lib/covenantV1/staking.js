...
exports.withdrawalUnbondingTransaction = exports.withdrawalTimeLockTransaction = exports.stakingTransaction = exports.buildDepositScript = exports.initBTCCurve = void 0;
...
function withdrawalTimeLockTransaction(scripts, stakingTransaction, withdrawalAddress, minimumFee, network, outputIndex = 0) {
    ...
    psbt.addInput({
        ...
        witnessScript: scripts.stakingScript,
        sequence: timelock
    });
    psbt.addOutput({
