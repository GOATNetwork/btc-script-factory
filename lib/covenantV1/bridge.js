...
exports.sendTransaction = exports.depositToFixedAddressTransaction = exports.depositTransaction = exports.buildDepositScript = void 0;
 ...
 */
function depositToFixedAddressTransaction(scripts, amount, fixedAddress, changeAddress, inputUTXOs, network, feeRate) {
    if (amount <= 0 || feeRate <= 0) {
        throw new Error("Amount and fee rate must be bigger than 0");
    }
    const psbt = new bitcoinjs_lib_1.Psbt({ network });
